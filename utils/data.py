...
class Data:
    ...
    def generate_instance(self, name):
        ...
        if name == "train":
            ...
            self.num_layer = len(self.train_texts[0][-1][0])
        elif name == "dev":
    ...
    def read_config(self,config_file):
        ...
        the_item = 'num_ne'
        if the_item in config:
            self.num_ne = int(config[the_item])
        the_item = 'sch_k'
        if the_item in config:
            self.sch_k = int(config[the_item])
        the_item = 'bias'
        if the_item in config:
            self.bias = int(config[the_item])
        the_item = 'max_depth'
        if the_item in config:
            self.max_depth = int(config[the_item])
        the_item = 'gcn_layer'
        if the_item in config:
            self.gcn_layer = int(config[the_item])
        ...
        the_item = 'lambda1'
        if the_item in config:
            self.lambda1 = float(config[the_item])
        the_item = 'lambda2'
        if the_item in config:
            self.lambda2 = float(config[the_item])
        ...
        the_item = 'learning_rate_gcn'
        if the_item in config:
            self.HP_lr_gcn = float(config[the_item])
        the_item = 'lr_decay'
        if the_item in config:
